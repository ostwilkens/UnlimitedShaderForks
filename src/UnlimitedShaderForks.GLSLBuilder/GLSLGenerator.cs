	...
	public class GLSLGenerator
	{
		...
		public string Generate()
		{
			...
			_vc = new ValueCollection(
				...
				CompositeFn.From((a1, a2) => a1 + a2),
				CompositeFn.From((a1, a2) => a1 - a2),
				CompositeFn.From(a1 => fn.Round(a1 * 10f) / 10f),
			...
			var l = main.Declare<float>("l", fn.Clamp(_vc.Complicate(times: 500), 0f, 0.95f));
			main.Set(c, fn.Vec3(1f / _vc.Complicate(500), 1f / _vc.Complicate(500), 1f / _vc.Complicate(500)));
			main.Set(c, c * 0.9f);
